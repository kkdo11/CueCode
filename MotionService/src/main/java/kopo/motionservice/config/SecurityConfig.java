...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // TrustedHeaderAuthenticationFilter를 UsernamePasswordAuthenticationFilter 이전에 추가
        http.addFilterBefore(new TrustedHeaderAuthenticationFilter(), UsernamePasswordAuthenticationFilter.class);
